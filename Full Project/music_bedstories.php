    ...
    <div class="container">
        <div class="row grid-row marg">
            <div class="col col-lg-6 col-md-6 col-sm-12 grid-col ">
                <img src="https://podcasts.podinstall.com/assets/img/rs/600/496ef7e738c0a8fb8188e4875ea50ea9fc50601e-a389e817.jpg" alt="relax" width="520" height="auto">
            </div>
            <div class="col col-lg-6 col-md-6 col-sm-12 grid-col ">
                <br>
                <h1>Different stories for sleep</h1>
                <br>
                <h2>This album consists of interesting bedtime stories. This album is recommended to listen to before
                    sleep.Enjoy listening!</h2>
            </div>
        </div>
        <?php
        require('connection.php');
        $query = "SELECT * FROM music WHERE id > 20";
