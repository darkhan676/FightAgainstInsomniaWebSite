    ...
    <div class="container">
        <div class="row grid-row marg">
            <div class="col col-lg-6 col-md-6 col-sm-12 grid-col ">
                <img src="https://direct.rhapsody.com/imageserver/images/alb.306402353/500x500.jpg" alt="relax" width="520" height="auto">
            </div>
            <div class="col col-lg-6 col-md-6 col-sm-12 grid-col ">
                <br>
                <h1> Rain Sounds</h1>
                <br>
                <h2>Rain sounds to help you meditate and fall asleep faster</h2>
            </div>
        </div>
        <?php
        require('connection.php');
        $query = "SELECT * FROM music WHERE id > 13 AND id <= 20";
